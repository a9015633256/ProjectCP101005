...
public class Common {
    ...
    public final static String URLForHen = "http://10.0.2.2:8080/PleaseLoginHen";
    public final static String URLForWenSing = "http://10.0.2.2:8080/SchoolConnectionBook";
